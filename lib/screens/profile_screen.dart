    ...
    return _InfoCard(
      child: Column(
        ...
        children: [
          ...
          _ContactRow(icon: Icons.email_outlined,    value: 'dr.foster@prodontics.in'),
          const SizedBox(height: 10),
          _ContactRow(icon: Icons.location_on_outlined, value: 'Kokapet, Hyderabad'),
          const SizedBox(height: 10),
          _ContactRow(
